...
int main(int argc, char *argv[])  // NS
{
  ...
  auto server =
      std::make_shared<llgc::pattern::publisher::PublisherTcpLinuxIpv4<
          llgc::protobuf::test::Tcp>>(8891);
  server->SetEncryption(llgc::net::OpenSsl::Presentation::TSL1_2, argv[1],
                        argv[2]);
  ...
  auto connector =
      std::make_shared<llgc::pattern::publisher::ConnectorPublisherTcpIpv4<
          llgc::protobuf::test::Tcp>>(subscriber, "127.0.0.1", 8891);
  connector->SetEncryption(llgc::net::OpenSsl::Presentation::TSL1_2, argv[1],
                           argv[2]);
